...
add_action( 'wp_enqueue_scripts' , 'canis_pro_enquque_scripts' );
function canis_pro_enquque_scripts()
{
	wp_enqueue_style( 'canis_pro_styles', BLANK_THEME_PRO_URI . '/pro.css' , array( 'canis-style' ) , BLANK_THEME_PRO_VERSION );
	wp_enqueue_script( 'canis_pro_scripts', BLANK_THEME_PRO_URI . '/js/pro.js' , array( 'jquery' ) , BLANK_THEME_PRO_VERSION, true );
}
